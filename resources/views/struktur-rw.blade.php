        ...
        <div class="org-chart">
          ...
          <div class="org-level">
            <div class="org-node ketua-rw">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_2.jpg') }}" alt="Ketua RW">
              </div>
          ...
          <div class="org-level">
            <div class="org-node wakil-ketua">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_3.jpg') }}" alt="Wakil Ketua I">
              </div>
              <div class="node-content">
                <h6>Wakil Ketua I</h6>
                <p>Budy Harsana</p>
            ...
            <div class="org-node wakil-ketua">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_4.jpg') }}" alt="Wakil Ketua II">
              </div>
              <div class="node-content">
            ...
            <div class="org-node wakil-ketua">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_1.jpg') }}" alt="Wakil Ketua III">
              </div>
              <div class="node-content">
          ...
          <div class="org-level">
            <div class="org-node sekretaris">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_2.jpg') }}" alt="Sekretaris">
              </div>
              <div class="node-content">
                <h6>Sekretaris</h6>
                <p>Untung Hidayat</p>
            ...
            <div class="org-node bendahara">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_3.jpg') }}" alt="Bendahara">
              </div>
              <div class="node-content">
                <h6>Bendahara</h6>
                <p>Ratna Andayani</p>
          ...
          <div class="org-level">
            <div class="org-node bidang">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_4.jpg') }}" alt="Bidang Keamanan">
              </div>
              <div class="node-content">
            ...
            <div class="org-node bidang">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_1.jpg') }}" alt="Bidang Kesra dan Sosial">
              </div>
              <div class="node-content">
          ...
          <div class="org-level">
            <div class="org-node penasehat">
              <div class="avatar-wrapper">
                <img src="{{ asset('frontend/images/person_1.jpg') }}" alt="Penasehat">
              </div>
              <div class="node-content">
                <h5>Penasehat</h5>
