  ...
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-md-7 text-center heading-section ftco-animate">
        <h2 class="mb-4">Pengurus RT RW 2 Sidotopo</h2>
        <span class="subheading">Pengurus RT 1, RT 2, RT 3</span>
      </div>
    </div>
      ...
      <div class="col-md-10">
        <div class="card bg-light">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Ketua RT 1">
                        </figure>
                      </div>
                      <div class="brxe-div">
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Sekretaris RT 1">
                        </figure>
                      </div>
                      <div class="brxe-div">
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Bendahara RT 1">
                        </figure>
                      </div>
                      <div class="brxe-div">
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Ketua RT 2">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Ketua RT</p>
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Sekretaris RT 2">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Sekretaris RT</p>
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Bendahara RT 2">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Bendahara RT</p>
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Ketua RT 3">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Ketua RT</p>
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Sekretaris RT 3">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Sekretaris RT</p>
                ...
                <div class="brxe-div post-animation card-employee__wrapper">
                  <div class="brxe-div flex--row justify-content--between align-items--center">
                    <div class="brxe-div flex--row justify-content--between align-items--center gap--s">
                      <div class="brxe-div avatar__wrapper">
                        <figure class="brxe-image avatar__image">
                          <img class="css-filter size-thumbnail" src="{{ asset('frontend/images/ketua.webp') }}" alt="Bendahara RT 3">
                        </figure>
                      </div>
                      <div class="brxe-div">
                        <p class="brxe-text-basic card-employee__position">Bendahara RT</p>
